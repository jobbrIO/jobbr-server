# Jobbr [![Build status](https://ci.appveyor.com/api/projects/status/4chtaw75i7jyejue?svg=true)](https://ci.appveyor.com/project/Jobbr/jobbr-server) [![NuGet][server-badge]][server]  [![NuGet][server-pre-badge]][server]
