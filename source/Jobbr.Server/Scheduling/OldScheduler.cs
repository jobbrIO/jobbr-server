...
////                catch (Exception e)
////                {
////                    Logger.ErrorException(string.Format("Exception thrown while creating schedule for trigger with Id '{0}' (Type: '{1}', userId: '{2}', userName: '{3}')", trigger.Id, trigger.GetType().Name, trigger.UserId, trigger.UserDisplayName), e);
////                }
////            }
////        }
...
////            {
////                Logger.WarnFormat("Active Disabling trigger for startdate '{0}', because historical startdate is not supported. Id '{1}' (Type: '{2}', userId: '{3}', userName: '{4}')", calculatedNextRun, trigger.Id, trigger.GetType().Name, trigger.UserId, trigger.UserDisplayName);
